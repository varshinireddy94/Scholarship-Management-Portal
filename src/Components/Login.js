...
render(){
    ...
    <Dialog  aria-labelledby="Login" open={this.state.showLogin} >
      <DialogTitle id="Login" style={{color:'#fff',backgroundColor:"#aaaaee"}}>Login for Scholarships</DialogTitle>
    ...
    Register
      ...
      <DialogTitle id="Login" style={{color:'#fff',backgroundColor:"#aaaaee"}}>Register for Scholarships</DialogTitle>
      <form style={{display:'flex',flexDirection:"column", padding:"10px",width:"400px"}}  >
