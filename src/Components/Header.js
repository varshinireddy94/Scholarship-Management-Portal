        ...
        <div style={{
           ...
           Scholarship Portal 
            ...
            <List>
                ...
                <Divider/>
                <Link to="/" style={{ textDecoration: 'none',display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
...
<Divider/>
<Link to="/openScholarships"  style={{textDecoration:"none"}} >
<ListItem>
        ...
        <ListItemIcon  >
            <FaBookOpen   style={{color:'#fff',height:20,width:20,marginLeft:10}}  />
        </ListItemIcon>
       
</ListItem>
</Link>
<Divider/>
<Link to="/appliedScholarships" style={{ textDecoration: 'none',display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
...
<ListItem>
        ...
        <ListItemIcon>
            <FaFileAlt   style={{color:'#fff',height:20,width:20,marginLeft:10}}/>
        </ListItemIcon>
       
</ListItem>
</Link>
<Divider/>
<Link to="/archivedScholarships" style={{ textDecoration: 'none',display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
...
<Divider/>
<Link to="/results" style={{ textDecoration: 'none',display:"flex",flexDirection:"row",alignItems:"center",justifyContent:"center"}}>
